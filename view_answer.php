...
$sql = "SELECT * FROM tbl_answer WHERE topic_ID = " . $_POST["topic_id"];
...
<tr>
	<td>Add comment</td>
	<td>
		<form action="add_to_topic.php" method="post">
	...
	<td>
		 ...
		 <input type="hidden" name="answer_ID" value="<?php echo $topic["answer_text"];?>"/>
