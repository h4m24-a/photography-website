...
<tr>
	...
	<td>
        <form method="post" action="view_answer.php">
			<input type="hidden" name="topic_id" value="<?php echo $topic["topic_ID"];?>"/>
			<input type="hidden" name="topic" value="<?php echo $topic["topic_detail"];?>"/>
	...
	<td>
         <form method="post" action="removeAnswer.php">
		 <input type="hidden" name="topic_id" value="<?php echo $topic["topic_ID"];?>"/>
	...
	{
		echo "You need to be admin to use this function";
	}
	?>
...
<br>
		<form action="add_new_topic.php" method="post">
			<input type="submit" name = "submit" value = "Add New Topic"/>
		</form>
</body>
</html>
